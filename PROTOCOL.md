...
> **v0.12.0 — Borrador Inicial — Febrero 2026**
>
...
- [1. Arquitectura del Protocolo](#1-arquitectura-del-protocolo)
  - [1.1 Roles del Protocolo](#11-roles-del-protocolo)
  - [1.2 Modelo de Puerta de Entrada (Verification Gate)](#12-modelo-de-puerta-de-entrada-verification-gate)
...
- [2. Estructura del Token AAVP](#2-estructura-del-token-aavp)
  ...
  - [Metadatos públicos vs. contenido cegado](#metadatos-públicos-vs-contenido-cegado)
  - [Test de minimalismo de los campos nuevos](#test-de-minimalismo-de-los-campos-nuevos)
  - [Campos explícitamente excluidos](#campos-explícitamente-excluidos)
  - [Generación del nonce](#generación-del-nonce)
- [3. Rotación de Tokens](#3-rotación-de-tokens)
- [4. Fundamentos Criptográficos](#4-fundamentos-criptográficos)
  - [4.1 Firmas Parcialmente Ciegas (Partially Blind Signatures)](#41-firmas-parcialmente-ciegas-partially-blind-signatures)
  - [4.2 Pruebas de Conocimiento Cero (ZKP)](#42-pruebas-de-conocimiento-cero-zkp)
  - [4.3 Prevención de Fingerprinting](#43-prevención-de-fingerprinting)
  - [4.4 Integridad del Dispositivo y Attestation](#44-integridad-del-dispositivo-y-attestation)
  - [4.5 Resistencia al Análisis de Tráfico](#45-resistencia-al-análisis-de-tráfico)
- [5. Modelo de Confianza Descentralizado](#5-modelo-de-confianza-descentralizado)
  ...
  - [5.3 Descubrimiento del Servicio](#53-descubrimiento-del-servicio)
  ...
  - [5.6 Analogía con DMARC/DKIM](#56-analogía-con-dmarcdkim)
- [6. Flujo Operativo Detallado](#6-flujo-operativo-detallado)
  - [6.1 Configuración Inicial (una sola vez)](#61-configuración-inicial-una-sola-vez)
  - [6.2 Acceso a una Plataforma (cada sesión)](#62-acceso-a-una-plataforma-cada-sesión)
  - [6.3 Desactivación](#63-desactivación)
- [7. Credencial de Sesión del Verification Gate](#7-credencial-de-sesión-del-verification-gate)
  ...
  - [7.2 Descarte obligatorio del token](#72-descarte-obligatorio-del-token)
  - [7.3 Estructura de la credencial de sesión](#73-estructura-de-la-credencial-de-sesión)
  - [7.4 Tiempo de vida y renovación](#74-tiempo-de-vida-y-renovación)
  - [7.5 Ciclo de vida](#75-ciclo-de-vida)
  - [7.6 Propiedades de seguridad](#76-propiedades-de-seguridad)
  - [7.7 Modelo aditivo y persistencia a nivel de cuenta](#77-modelo-aditivo-y-persistencia-a-nivel-de-cuenta)
  - [7.8 Escenarios de borde](#78-escenarios-de-borde)
  - [7.9 Compatibilidad con arquitecturas CDN y edge](#79-compatibilidad-con-arquitecturas-cdn-y-edge)
- [8. Segmentation Accountability Framework (SAF)](#8-segmentation-accountability-framework-saf)
  - [8.1 Motivación y alcance](#81-motivación-y-alcance)
  - [8.2 Segmentation Policy Declaration (SPD)](#82-segmentation-policy-declaration-spd)
  - [8.3 Policy Transparency Log (PTL)](#83-policy-transparency-log-ptl)
  - [8.4 Open Verification Protocol (OVP)](#84-open-verification-protocol-ovp)
  - [8.5 Señal de cumplimiento](#85-señal-de-cumplimiento)
  - [8.6 Niveles de conformidad](#86-niveles-de-conformidad)
  - [8.7 Límites y riesgo residual](#87-límites-y-riesgo-residual)
- [9. Protocolo de Conformidad y Auditoría](#9-protocolo-de-conformidad-y-auditoría)
  - [9.1 Principios del marco de conformidad](#91-principios-del-marco-de-conformidad)
  - [9.2 Requisitos de conformidad por rol](#92-requisitos-de-conformidad-por-rol)
  - [9.3 Metodología de verificación](#93-metodología-de-verificación)
  - [9.4 Niveles de conformidad de implementaciones](#94-niveles-de-conformidad-de-implementaciones)
  - [9.5 Verificación operacional continua](#95-verificación-operacional-continua)
  - [9.6 Fuentes y referencias del marco de conformidad](#96-fuentes-y-referencias-del-marco-de-conformidad)
...
**AAVP** · Anonymous Age Verification Protocol · Especificación Técnica · v0.12.0
